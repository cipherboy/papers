...
use as file integrity checks to verify long term storage of
...
cryptanalysis hold: namely the existance of useful distance
heuristics; the existance of a similarity operator, $\precsim$,
between families of collision classes; and the existance of a useful
heuristic structure for second preimage and chosen prefix attacks.
These theories lead to techniques which result in a 35 fold increase in collision
