...
$\mathcal{C}$ for collision class. Ordered tuple, indexable.
$\mathcal{F}$ for family of collision classes. Ordered set, indexable.
$[i]$ is an indexing function.
$R$ is number of rounds of $F$ or $C$.





\section{Measuring the Utility of a Collision}
...
The implications of collision class neighborhoods are discussed further in
section \ref{empirical:neighborhood}.
...
\section{New Collision}


\section{Broader Impacts}

\textbf{TODO} - Discuss impacts on real-world systems like MD5, SHA-1, etc.
