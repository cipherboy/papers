...
in Section \ref{Sec:Logical}. Lastly, we discuss the broader impacts and
conclusions of this research in Section \ref{Sec:Conclusion}, discussing future work and
...
- Theory behind Logical Cryptanalysis:
    - Distance heuristic.
    - $\precsim$.
- Tie into Trustworthiness of hash functions.
- Demonstrated metrics.
- Demonstrated 35k new collisions.
- Implications to real world systems.
