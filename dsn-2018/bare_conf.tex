...
\subsection{Logical Cryptanalysis}

\textbf{TODO}

Logical Cryptanalysis and its encoding as SAT likely started under the work of
F. Massacci in early 2000 with his paper titled ``Logical Cryptanalysis as a
SAT Problem: Encoding and Analysis of the U.S. Data Encryption Standard''.
...
\section{New Collision} \label{Sec:Collision}
